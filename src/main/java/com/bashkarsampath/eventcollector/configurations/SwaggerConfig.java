...
public class SwaggerConfig {
	...
	public ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Kafka")
				.contact(new Contact("Bashkar Sampath", "www.linkedin.com/in/bashkarsampath",
						"bashkarsampath@gmail.com"))
				.version("1.0").description("Kafka desc").termsOfServiceUrl("http://swagger.io/terms/")
